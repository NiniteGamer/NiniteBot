...
exports.run = async (client, message, args, ops) => {
    ...
    console.debug("**DEBUG** " + ops.active)

    logger.info(`${message.author.tag} has ran the !play command on guild ${message.guild.name}, with the args of ${args[0]}`);
    logger.debug("**DEBUG** " + ops.active)
